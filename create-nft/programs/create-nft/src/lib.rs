...
pub mod create_nft {
    ...
    pub fn init_nft(
        ...
        let  cpi_context = CpiContext::new(
            ...
            MintTo {
                ...
                to: ctx.accounts.associated_token_account.to_account_info(), //instead of token
                authority: ctx.accounts.signer.to_account_info(),
            },
        );

        mint_to(cpi_context, 1)?; //mint one nft
    ...
    /*pub fn mint_nft(ctx: Context<MintTokens>, quantity: u64) -> Result<()> {
